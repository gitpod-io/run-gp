...
var preflightCmd = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		go func() {
			...
			clusterHost := os.Getenv("GITPOD_WORKSPACE_CLUSTER_HOST")
			runLogs := console.Observe(ctx, log, console.WorkspaceAccessInfo{
				WorkspaceURL:    workspaceURL,
				SSHCommand:      "ssh 'debug-" + workspaceId + "@" + workspaceURL.Host + ".ssh." + clusterHost + "'",
...
func init() {
	...
	preflightCmd.Flags().StringVar(&preflightOpts.IDEPath, "ide-path", "", "IDE path")
